...
<head>
    ...
    <title>Contact Us – Xinterio Demo1 HTML Template</title>
							...
							<article class="pbmit-miconheading-style-7 swiper-slide">
								<div class="pbmit-ihbox-style-7">
									...
									<div class="pbmit-ihbox-btn">
										<a class="pbmit-button-inner" href="about-us.php">
									...
									<div class="contact-us-left-area">
										<div class="pbmit-heading-subheading animation-style2">
											...
											<div class="pbmit-heading-desc">
												Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labo et dolo cupidatat non proident, sunt in culpa qui officia deserunt anim id est laborum.
											</div>
										</div>
									</div>
								</div>
								...
								<div class="contact-form-area">
									...
									<form class="contact-form" method="post" id="contact-form" action="send-dummy.php">
										<div class="row">
											...
											<div class="col-md-6">
												<input type="email" class="form-control" placeholder="Your Name *" name="email" required>
											</div>
											<div class="col-md-6">
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-md-4 pbmit-footer-left">
							<span class="pbmit-email-text"> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="046c6168686b44617c65697468612a676b69">[email&#160;protected]</a></span>
